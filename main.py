...
#Приветствие пользователя, основные инструкции
print('Привет! Вы попали в базу данных 10 самых крутых IT-компаний с сайта HeadHunter.\nВыберите '
...
while user_choice != 'z':
    ...
    if user_choice == 'z':
        ...
        user_choice = input('Вы ввели неверное значение. Пожалуйста, попробуйте еще раз или нажмите z для завершения программы ')
